...
public class CommentController {
    ...
    public String createComment(@PathVariable("imageTitle") String title, @PathVariable("imageId") Integer id, Comment newComment, HttpSession session, RedirectAttributes redirectAttrs) throws IOException {
